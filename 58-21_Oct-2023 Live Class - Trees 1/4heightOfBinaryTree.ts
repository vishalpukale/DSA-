...
let treeArr = [8,3,1,-1,-1,6,4,-1,-1,7,-1,-1,10,-1,14,13,-1,-1,  10, 20, -1, -1,-1,];
let i = 0;
...
function heightOfBinaryTree(root : TreeNode | null): number {
    ...
    let leftMax : number = heightOfBinaryTree(root.left);
    let rightMax : number = heightOfBinaryTree(root.right);
